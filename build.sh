...
arr[2,file]=run_refactoring_and_print.sh
arr[3,file]=run_obuchaika.sh
arr[0,folder]=dsedegova_bubble
arr[1,folder]=bubble_sort_mf
arr[2,folder]=refactoring_and_print
arr[3,folder]=obuchaika
